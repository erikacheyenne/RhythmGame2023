...
define gui.main_menu_background = Movie(play="videos/open.webm", pos=(0, 0), anchor=(0, 0), size=(1280, 720))
define gui.game_menu_background = Movie(play="videos/open.webm", pos=(0, 0), anchor=(0, 0), size=(1280, 720))
...
define gui.choice_button_width = 600#controla a largura dos botões do menu de label e as letras se ajustão a essa largura
...
define gui.choice_button_text_idle_color = "#6495ED"#"#cccccc"
define gui.choice_button_text_hover_color = "#ADD8E6"#"#ffffff"
